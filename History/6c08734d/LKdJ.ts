...
export class Users extends BaseEntity {
    ...
    @JoinTable({name:"products_contrate",joinColumn: {name:"user_idContrate",referencedColumnName:"product_id"},inverseJoinColumn:{name:"product_idContrate",referencedColumnName:"user_id"} })
