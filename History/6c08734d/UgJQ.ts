...
export class Users extends BaseEntity {
    ...
    @JoinTable({name:"contrate_products",joinColumn: {name:"user_idContrate",referencedColumnName:"id"},inverseJoinColumn:{name:"product_idContrate",referencedColumnName:"id"} })
