...
export class Users extends BaseEntity {
    ...
    @JoinTable({name:"contrate_products",joinColumn: {name:"user_id",referencedColumnName:"user_id"},inverseJoinColumn:{name:"product_id",referencedColumnName:"product_id"} })
