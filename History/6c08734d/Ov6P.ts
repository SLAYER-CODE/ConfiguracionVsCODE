...
export class Users extends BaseEntity {
    ...
    @JoinTable({name:"contrate_user",joinColumn: {name:"user_idContrate",referencedColumnName:"user_id"},inverseJoinColumn:{name:"product_idContrate",referencedColumnName:"product_id"} })
