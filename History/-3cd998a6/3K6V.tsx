                            ...
                            locations.map((e: Get_Location_Services_GpsServices, index) => {
                                ...
                                return (
                                    <MapboxGL.MarkerView onSelected={() => {
                                        ...
                                        <View>
                                            <View style={[stylera.markerContainer,{backgroundColor:asd,borderRadius:50,justifyContent:'center'}]}>
                                                <View style={{position:'absolute'}}>
                                                    <Text style={{textShadowColor:'black',color:'white',textShadowRadius:5,fontWeight:'bold',fontSize:8,textAlign:'center'}}> {e.gps_relation?.product_name}</Text>
                                                </View>
                                            </View>
                                        </View>
                                    </MapboxGL.MarkerView>
