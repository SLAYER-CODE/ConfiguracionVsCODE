...
function Productos() {
    ...
    return (
        <SafeAreaView style={[{ width: "100%", height: "100%", paddingTop: 50, alignContent: 'center', backgroundColor: '#ff8000' }]}>
            <View style={{ position: 'absolute', top: 50, zIndex: 1, width: 90, borderRadius: 20, padding: 5, borderColor: "white", justifyContent: 'center', alignContent: 'center', alignItems: "center", backgroundColor: "white",flexDirection:'row',flexShrink:1,flexWrap:"wrap" }}>
            ...
            <View style={{ backgroundColor: "#12312350", margin: 9, borderRadius: 20,flex:1 }}>
