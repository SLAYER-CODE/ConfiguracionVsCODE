...
function Productos() {
    ...
    return (
        <SafeAreaView style={[{ width: "100%", height: "100%", paddingTop: 50, alignContent: 'center', backgroundColor: '#ff8000' }]}>
            ...
            <View style={{ height: "41%", width: "100%", backgroundColor: "#ffffff60", marginTop: 20, flexGrow: 1 }}>
            ...
            <View style={{ backgroundColor: "#12312350", margin: 9, borderRadius: 20,flexWrap:"nowrap" }}>
