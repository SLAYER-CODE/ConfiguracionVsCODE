                    ...
                    {data?.ProductsProfile
                        .map((product, i) => {
                            return <View style={{
                                ...
                                , borderRadius: 30, borderWidth: 2, flex: 0, height: 200, width: 150
                            }}>
                                ...
                                <View style={{ width: "100%", height: 80, position: 'absolute', borderRadius: 25, backgroundColor: "#ffffff60", bottom: 0, flex: 1 }}>
