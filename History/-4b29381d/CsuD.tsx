        ...
        if (item.product_name.toUpperCase().includes(searchPhrase.toUpperCase().trim().replace(/\s/g, ""))) {
            ...
            return (
                <View style={{ flexDirection: 'row',width:"100%"}}>
                    ...
                    ) : <IconMaterialComm name='ios-people-circle-outline' style={{alignContent:'center',justifyContent:'center',alignItems:'center',alignSelf:'flex-end'}} size={40}></IconMaterialComm>
                    }
                </View>
            )
        }
