...
function SearchTab() {
    ...
    const renderItem: ListRenderItem<Get_Producto_Products> = ({ item }) => {
        if (item.product_name.toUpperCase().includes(searchPhrase.toUpperCase().trim().replace(/\s/g, ""))) {
            ...
            return (
                <View style={{ flexDirection: 'row',width:"100%"}}>
                    ...
                    ) : <IconMaterialComm name='ios-people-circle-outline' style={{alignContent:'center',justifyContent:'center',alignItems:'center',textAlign:'center',textAlignVertical:'center'}} size={40}></IconMaterialComm>
                    }
                </View>
            )
        }
