...
export class Products extends BaseEntity {
    ...
    @Field(() => [Users],{nullable:true})
    @JoinTable({name:"products_contrate",inverseJoinColumn: {name:"user_idContrate",referencedColumnName:"user_id"},joinColumn:{name:"product_idContrate",referencedColumnName:"product_id"} })
    products_contrate?: Users[] 
}
