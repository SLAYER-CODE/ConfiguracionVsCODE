...
export class Products extends BaseEntity {
    ...
    @OneToMany(() => ProductImages, (productoImages) => productoImages.product_relation, { cascade: false,eager:true})
    // @TypeormLoader((course: Products) => course.user_id, { selfKey: true })
    userProducts?: ProductImages[];
}
...
export class ProductImages extends BaseEntity {
    ...
    //Product
    @ManyToOne(type => Products, product_id => product_id.userProducts, {
        cascade: ["remove", "update"], onUpdate: "CASCADE", onDelete: "NO ACTION", createForeignKeyConstraints: true,eager:true
    })
