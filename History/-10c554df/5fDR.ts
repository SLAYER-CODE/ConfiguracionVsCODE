...
export class Products extends BaseEntity {
    ...
    @Field(() => [Users],{nullable:true})
    @JoinTable({name:"product_category",joinColumn: {name:"product_id",referencedColumnName:"product_id"},inverseJoinColumn:{name:"user_id",referencedColumnName:"user_id"} })
    contrate_user?: Users[] 
