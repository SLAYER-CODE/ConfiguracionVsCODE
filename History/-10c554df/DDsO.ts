...
export class Products extends BaseEntity {
    ...
    @ManyToMany(type => Users, user_product => user_product.user_id, {
        cascade: ["remove", "update","insert",],eager:true
    })
    @Field(() => [Users],{nullable:true})
    @JoinTable({name:"contrate_user",joinColumn: {name:"product_idContrate",referencedColumnName:"product_id"},inverseJoinColumn:{name:"user_idContrate",referencedColumnName:"user_id"} })
    contrate_user?: Users[] 
