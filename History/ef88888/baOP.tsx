        ...
        <SafeAreaView style={[styles.container, { backgroundColor: '#ff8400' }]}>
            ...
            <View style={{
                ...
                <View style={{ width: 280, height: 400, padding: 15, top: 250 }}>
                    ...
                    {/* </View> */}
                    <AwesomeButton disabled={!button} progress style={{ height: 40 ,top:20}} backgroundDarker={'#fff200'} borderColor={'aqua'} width={150} height={40} textColor='black' borderWidth={1.5}  backgroundColor={!button?'#00ACB240':'#00FFE560'} backgroundShadow={'#4C63D2'} springRelease onPress={(nexttt?:AfterPressFn) => {
                        nexttt!(async()=>{
