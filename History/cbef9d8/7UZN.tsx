...
import { ADD_USERVariables, ADD_USER_createSessions, COMPROBATION_SESSIONS, COMPROBATION_SESSIONS, COMPROBATION_SESSIONS, UsersInput } from '../GraphQl/Sdls/type-operation';
...
function Autenticate() {
  ...
  const [comprobation, {loading, data}] = useLazyQuery<COMPROBATION_SESSIONS>(COMPROBATION_SESSIONS);
