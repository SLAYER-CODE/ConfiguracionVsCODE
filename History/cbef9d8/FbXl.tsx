...
import { ADD_USERVariables, ADD_USER_createSessions, COMPROBATION_SESSIONS, COMPROBATION_SESSIONS, COMPROBATION_SESSIONS, COMPROBATION_SESSIONSS, UsersInput } from '../GraphQl/Sdls/type-operation';
...
function Autenticate() {
  ...
  const [comprobation, {loading, data}] = useLazyQuery<COMPROBATION_SESSIONSS>(COMPROBATION_SESSIONS);

  const [addUser, {loading: loadadd, data: dataadd}] = useMutation<ADD_USER_createSessions>(ADD_USER);
