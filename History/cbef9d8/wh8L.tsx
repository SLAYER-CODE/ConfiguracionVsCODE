    ...
    <>
      <SafeAreaView style={[styles.container, { backgroundColor: '#fa7907' }]}>
        ...
        <View
          ...
          <Text style={{ fontWeight: 'bold' ,top:10,color:'#FFF',textShadowColor:'black',textShadowRadius:5 }}>
          Las presentes condiciones generales regulan el uso de las aplicaciones informáticas móviles y web (en adelante, la “Aplicación”) de Document Work Services, (en adelante “DWS”).          </Text>
          <View
            style={{
              width: 280,
              height: 400,
