...
<head>
	...
	<script>
		function FristItem(KeyItem, VariableSend,keyItem) {
			//console.log(KeyItem)
			...
			if ((!isNaN(parseInt(KeyItem)))) {
				...
				if (KeyItem.length == 0) {
					...
					xmlhttp.onreadystatechange = function() {
						if (this.readyState == 4 && this.status == 200) {
							document.getElementById("FristItem").innerHTML = this.responseText;
						}
					};
				...
				if (KeyItem.length >= 1) {
					document.getElementById("basic-frist").innerHTML=KeyItem[0];
				}else{
					console.log("Se envio")
					document.getElementById("basic-frist").innerHTML="m"
				}
			}
		}
	</script>
			...
			<div class="card-body text-center center text-black bg-primary mb-3">
				...
				<form name="number" action="#" method="POST">
					...
					<div class="input-group mb-3">
						...
						<input onkeyup="FristItem(this.value,'fnumber')" type="text" class="form-control" placeholder="Primer Numero" aria-label="Recipient's username" aria-describedby="basic-addon2" />
					...
					<div class="input-group mb-3">
						...
						<input onkeyup="FristItem(this.value,'snumber')" type="text" class="form-control" placeholder="Coeficiente, Variable" aria-label="Recipient's username" aria-describedby="basic-addon2" />
						<div class="input-group-append">
					...
					<div class="input-group mb-3">
						...
						<input onkeyup="FristItem(this.value,'tnumber')" type="text" class="form-control" placeholder="Radical Numero" aria-label="Recipient's username" aria-describedby="basic-addon2" />
						<div class="input-group-append">
