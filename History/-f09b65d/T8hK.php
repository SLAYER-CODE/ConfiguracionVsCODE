...
<head>
	...
	<script>
		function CreateExyRad(n,a,m){
			var res = '\[A). {\sqrt[m]{a \div \sqrt[m]{a \div \cdots}} } '
			document.getElementById("resultEcuacion").innerHTML = res
		}
				...
				if (KeyItem.length == 0) {
					...
					xmlhttp.onreadystatechange = function() {
						if (this.readyState == 4 && this.status == 200) {
							document.getElementById("FristItem").innerHTML = JSON.parse(this.responseText).voids;
	...
	<div class="d-flex">
		...
		<div class="flex-fill m-2">
			...
			<div class="minotacionmatematica4">
				...
				<p id="resultEcuacion">
					\[A). {\sqrt[m]{a \times \sqrt[m]{a \times \cdots}} } = (\sqrt[m^n]{a})^{m^n-1 \over m-1} \]
				</p>
