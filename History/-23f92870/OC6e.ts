...
export async function StartServer() {
    ...
    const server = new ApolloServer({
        ...
        context:  async ({ req, res }) => {
            // console.log(res)
            loggerServer.info("Creando un Contexto"+req.headers.location)
            loggerServer.info("Creando un Contexto"+req.cookies)
            loggerServer.info("Creando un Contexto"+req.url)
            loggerServer.info("Creando un Contexto"+req.headers.from)
