...
import { Get_Producto_Products_gps_relation, Get_PRoducto_Profile_USers_ProductsProfile_products_contrate_gps_id } from '../../../../GraphQl/Types';
export type ClientLocationProps = {
    Locations: Get_PRoducto_Profile_USers_ProductsProfile_products_contrate_gps_id | null;
    Name: string,
    photo: string | null
};
        ...
        <SafeAreaView style={[styles.container, { backgroundColor: '#ff7b00' }]}>
            ...
            <MapboxGL.MapView onPress={(b) => { console.log((b.geometry as any).coordinates) }} localizeLabels={true} logoEnabled={false} style={styler.map} >
                ...
                {locations != undefined ? (
                    ...
                    }} id={"1"} coordinate={[parseFloat(locations.longitud), parseFloat(locations.latitud)]}>
                        ...
                        <View>
                            <View style={[stylera.markerContainer, { backgroundColor: 'red', borderRadius: 50, justifyContent: 'center', alignContent: 'center' }]}>
                                <View style={{ position: 'absolute',justifyContent: 'center', alignContent: 'center' }}>
                                    ...
                                    {
                                     image!=undefined?(
                                        <Image source={{uri:image}} style={{width:50,height:50,alignContent:'center',justifyContent:'center',position:'absolute',alignItems:'center',alignSelf:'center'}}>
