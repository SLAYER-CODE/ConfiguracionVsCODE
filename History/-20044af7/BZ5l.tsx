...
function Categorias() {
    ...
    return (
        ...
        alignItems: 'center',position:'absolute' }]}>
            <ScrollView horizontal={false} scrollEnabled={true} style={{ width: "100%", flex: 1, flexDirection: 'column', marginTop: 30 , height:'100%',alignContent: 'center'}}>
                ...
                {data && data.Categories.length != 0 ? (
                    ...
                    <View style={{justifyContent:'center',alignItems:'center',alignContent:'center', position: 'relative',top:"50%" }}>
